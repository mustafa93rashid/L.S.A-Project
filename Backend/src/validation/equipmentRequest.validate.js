...
const createEquipmentRequestValidation = [
  ...
  body("company")
    ...
    .withMessage(
      "Company must be between 2 and 200 characters.",
    ),
  ...
  body("workLocation")
    ...
    .withMessage(
      "Work location must be between 2 and 250 characters.",
    ),
  ...
  body("workDescription")
    ...
    .withMessage(
      "Work description must be between 10 and 5000 characters.",
    ),
...
const updateEquipmentRequestStatusValidation = [
  body("status")
    ...
    .isString()
    .withMessage(
      "Request status must be a string.",
    )
    .bail()
    .isIn(
      EQUIPMENT_REQUEST_STATUSES,
...
const equipmentRequestIdValidation = [
  param("id")
    ...
    .isMongoId()
    .withMessage(
      "Equipment request ID must be valid.",
    ),
...
const equipmentRequestQueryValidation = [
  ...
  query("equipment")
    ...
    .isMongoId()
    .withMessage(
      "Equipment filter must be a valid ID.",
    ),
  ...
  query("assignedTo")
    ...
    .isMongoId()
    .withMessage(
      "Assigned user filter must be a valid ID.",
    ),
