...
function SheetContent({
  ...
  /** Override when SheetContent's own background isn't `bg-popover` (e.g.
   * the navy-branded navigation Sheet) — the close button otherwise
   * inherits `text-popover-foreground`, which can be illegible against a
   * differently-colored custom background. */
